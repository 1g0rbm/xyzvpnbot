...
admin_error_template: `⚠ АЛЯРМА ⚠
Произошел ошибка:
{{ message }}`,
user_error_template: `Ой, что-то пошло не так... 😔
Попробуй повторить действие позже.`,
account_creating: `Мне потребуется немного времени для создания аккаунта...
Я сообщу, когда все будет готово. 😊`
    },
  }
}
